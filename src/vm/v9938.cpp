...
void v99x8_device::default_border(const scrntype_t *pens, scrntype_t *ln)
{
	scrntype_t pen;
	int i;
...
void v99x8_device::graphic7_border(const scrntype_t *pens, scrntype_t *ln)
{
	scrntype_t pen;
	int i;
...
void v99x8_device::graphic5_border(const scrntype_t *pens, scrntype_t *ln)
{
	int i;
	scrntype_t pen0;
	scrntype_t pen1;
...
void v99x8_device::mode_text1(const scrntype_t *pens, scrntype_t *ln, int line)
{
	int pattern, x, xx, name, xxx;
	scrntype_t fg, bg, pen;
...
void v99x8_device::mode_text2(const scrntype_t *pens, scrntype_t *ln, int line)
{
	int pattern, x, charcode, name, xxx, patternmask, colourmask;
	scrntype_t fg, bg, fg0, bg0, pen;
...
void v99x8_device::mode_multi(const scrntype_t *pens, scrntype_t *ln, int line)
{
	int nametbl_addr, patterntbl_addr, colour;
	int name, line2, x, xx;
	scrntype_t pen, pen_bg;
...
void v99x8_device::mode_graphic1(const scrntype_t *pens, scrntype_t *ln, int line)
{
	scrntype_t fg, bg, pen;
	int nametbl_addr, patterntbl_addr, colourtbl_addr;
...
void v99x8_device::mode_graphic23(const scrntype_t *pens, scrntype_t *ln, int line)
{
	scrntype_t fg, bg, pen;
	int nametbl_addr, patterntbl_addr, colourtbl_addr;
...
void v99x8_device::mode_graphic4(const scrntype_t *pens, scrntype_t *ln, int line)
{
...
void v99x8_device::mode_graphic5(const scrntype_t *pens, scrntype_t *ln, int line)
{
	int nametbl_addr, colour;
	int line2, linemask, x, xx;
...
void v99x8_device::mode_graphic6(const scrntype_t *pens, scrntype_t *ln, int line)
{
	UINT8 colour;
...
void v99x8_device::mode_graphic7(const scrntype_t *pens, scrntype_t *ln, int line)
{
	UINT8 colour;
	int line2, linemask, x, xx, nametbl_addr;
	scrntype_t pen, pen_bg;
...
void v99x8_device::mode_unknown(const scrntype_t *pens, scrntype_t *ln, int line)
{
	scrntype_t fg, bg;
	int x;
...
void v99x8_device::default_draw_sprite(const scrntype_t *pens, scrntype_t *ln, UINT8 *col)
{
	int i;
	ln += m_offset_x * 2;
...
void v99x8_device::graphic5_draw_sprite(const scrntype_t *pens, scrntype_t *ln, UINT8 *col)
{
	int i;
	ln += m_offset_x * 2;
...
void v99x8_device::graphic7_draw_sprite(const scrntype_t *pens, scrntype_t *ln, UINT8 *col)
{
