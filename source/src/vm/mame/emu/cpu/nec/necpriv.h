...
#define read_mem_byte(a)			nec_state->program->read_data8(a)
#define read_mem_word(a)			nec_state->program->read_data16(a)
#define write_mem_byte(a,d)			nec_state->program->write_data8((a),(d))
#define write_mem_word(a,d)			nec_state->program->write_data16((a),(d))

#define read_port_byte(a)		nec_state->io->read_io8(a)
#define read_port_word(a)		nec_state->io->read_io16(a)
#define write_port_byte(a,d)	nec_state->io->write_io8((a),(d))
#define write_port_word(a,d)	nec_state->io->write_io16((a),(d))
