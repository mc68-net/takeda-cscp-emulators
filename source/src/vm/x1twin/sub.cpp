...
static const int key_numpad_code[256] = {
//	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x65, 0x00, 0x00, 0x00,
//	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
//	,
...
void SUB::key_down(int code, bool repeat)
{
	// shift + numpad (for xanadu)
	if(!repeat && (key_shift || key_shift_released)) {
		if(key_numpad_code[code] != 0) {
			key_converted[code] = true;
			key_shift = true;
			code = key_numpad_code[code];
		}
	}
	
	// check keycode
	switch(code) {
	case 0x10: key_shift = true; return;
	case 0x11: key_ctrl = true; return;
	case 0x12: key_graph = true; return;
	case 0x14: key_caps = !key_caps; return;
	case 0x15: key_kana = !key_kana; return;
	}
...
{
	// shift + numpad (for xanadu)
	if(key_converted[code]) {
		key_converted[code] = false;
		code = key_numpad_code[code];
	}
	
	// check keycode
	switch(code) {
	case 0x10: key_shift = false; key_shift_released = true; return;
	case 0x11: key_ctrl = false; return;
	case 0x12: key_graph = false; return;
	}
	if(code == key_prev) {
...
uint16 SUB::get_key(int code, bool repeat)
{
	uint8 l = 0xff, h = 0;
