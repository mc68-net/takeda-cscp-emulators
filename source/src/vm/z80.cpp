...
int dasm(uint32 pc, _TCHAR *buffer, size_t buffer_len)
{
	...
	case 0x01: _stprintf_s(buffer, buffer_len, _T("LD BC, %04x"), debug_fetch16()); break;
	...
	case 0x06: _stprintf_s(buffer, buffer_len, _T("LD B, %02x"), debug_fetch8()); break;
	...
	case 0x0e: _stprintf_s(buffer, buffer_len, _T("LD C, %02x"), debug_fetch8()); break;
	case 0x0f: _stprintf_s(buffer, buffer_len, _T("RRCA")); break;
	case 0x10: _stprintf_s(buffer, buffer_len, _T("DJNZ %04x"), debug_fetch8_relpc(pc)); break;
	case 0x11: _stprintf_s(buffer, buffer_len, _T("LD DE, %04x"), debug_fetch16()); break;
	...
	case 0x16: _stprintf_s(buffer, buffer_len, _T("LD D, %02x"), debug_fetch8()); break;
	case 0x17: _stprintf_s(buffer, buffer_len, _T("RLA")); break;
	case 0x18: _stprintf_s(buffer, buffer_len, _T("JR %04x"), debug_fetch8_relpc(pc)); break;
	...
	case 0x1e: _stprintf_s(buffer, buffer_len, _T("LD E, %02x"), debug_fetch8()); break;
	case 0x1f: _stprintf_s(buffer, buffer_len, _T("RRA")); break;
	case 0x20: _stprintf_s(buffer, buffer_len, _T("JR NZ, %04x"), debug_fetch8_relpc(pc)); break;
	case 0x21: _stprintf_s(buffer, buffer_len, _T("LD HL, %04x"), debug_fetch16()); break;
	case 0x22: _stprintf_s(buffer, buffer_len, _T("LD (%04x), HL"), debug_fetch16()); break;
	...
	case 0x26: _stprintf_s(buffer, buffer_len, _T("LD H, %02x"), debug_fetch8()); break;
	case 0x27: _stprintf_s(buffer, buffer_len, _T("DAA")); break;
	case 0x28: _stprintf_s(buffer, buffer_len, _T("JR Z, %04x"), debug_fetch8_relpc(pc)); break;
	case 0x29: _stprintf_s(buffer, buffer_len, _T("ADD HL, HL")); break;
	case 0x2a: _stprintf_s(buffer, buffer_len, _T("LD HL, (%04x)"), debug_fetch16()); break;
	...
	case 0x2e: _stprintf_s(buffer, buffer_len, _T("LD L, %02x"), debug_fetch8()); break;
	case 0x2f: _stprintf_s(buffer, buffer_len, _T("CPL")); break;
	case 0x30: _stprintf_s(buffer, buffer_len, _T("JR NC, %04x"), debug_fetch8_relpc(pc)); break;
	case 0x31: _stprintf_s(buffer, buffer_len, _T("LD SP, %04x"), debug_fetch16()); break;
	case 0x32: _stprintf_s(buffer, buffer_len, _T("LD (%04x), A"), debug_fetch16()); break;
	...
	case 0x36: _stprintf_s(buffer, buffer_len, _T("LD (HL), %02x"), debug_fetch8()); break;
	case 0x37: _stprintf_s(buffer, buffer_len, _T("SCF")); break;
	case 0x38: _stprintf_s(buffer, buffer_len, _T("JR C, %04x"), debug_fetch8_relpc(pc)); break;
	case 0x39: _stprintf_s(buffer, buffer_len, _T("ADD HL, SP")); break;
	case 0x3a: _stprintf_s(buffer, buffer_len, _T("LD A, (%04x)"), debug_fetch16()); break;
	...
	case 0x3e: _stprintf_s(buffer, buffer_len, _T("LD A, %02x"), debug_fetch8()); break;
	...
	case 0xc2: _stprintf_s(buffer, buffer_len, _T("JP NZ, %04x"), debug_fetch16()); break;
	case 0xc3: _stprintf_s(buffer, buffer_len, _T("JP %04x"), debug_fetch16()); break;
	case 0xc4: _stprintf_s(buffer, buffer_len, _T("CALL NZ, %04x"), debug_fetch16()); break;
	case 0xc5: _stprintf_s(buffer, buffer_len, _T("PUSH BC")); break;
	case 0xc6: _stprintf_s(buffer, buffer_len, _T("ADD A, %02x"), debug_fetch8()); break;
	...
	case 0xca: _stprintf_s(buffer, buffer_len, _T("JP Z, %04x"), debug_fetch16()); break;
	case 0xcb: dasm_cb(pc, buffer, buffer_len); break;
	case 0xcc: _stprintf_s(buffer, buffer_len, _T("CALL Z, %04x"), debug_fetch16()); break;
	case 0xcd: _stprintf_s(buffer, buffer_len, _T("CALL %04x"), debug_fetch16()); break;
	case 0xce: _stprintf_s(buffer, buffer_len, _T("ADC A, %02x"), debug_fetch8()); break;
	...
	case 0xd2: _stprintf_s(buffer, buffer_len, _T("JP NC, %04x"), debug_fetch16()); break;
	case 0xd3: _stprintf_s(buffer, buffer_len, _T("OUT (%02x), A"), debug_fetch8()); break;
	case 0xd4: _stprintf_s(buffer, buffer_len, _T("CALL NC, %04x"), debug_fetch16()); break;
	case 0xd5: _stprintf_s(buffer, buffer_len, _T("PUSH DE")); break;
	case 0xd6: _stprintf_s(buffer, buffer_len, _T("SUB %02x"), debug_fetch8()); break;
	...
	case 0xda: _stprintf_s(buffer, buffer_len, _T("JP C, %04x"), debug_fetch16()); break;
	case 0xdb: _stprintf_s(buffer, buffer_len, _T("IN A, (%02x)"), debug_fetch8()); break;
	case 0xdc: _stprintf_s(buffer, buffer_len, _T("CALL C, %04x"), debug_fetch16()); break;
	case 0xdd: dasm_dd(pc, buffer, buffer_len); break;
	case 0xde: _stprintf_s(buffer, buffer_len, _T("SBC A, %02x"), debug_fetch8()); break;
	...
	case 0xe2: _stprintf_s(buffer, buffer_len, _T("JP PO, %04x"), debug_fetch16()); break;
	case 0xe3: _stprintf_s(buffer, buffer_len, _T("EX HL, (SP)")); break;
	case 0xe4: _stprintf_s(buffer, buffer_len, _T("CALL PO, %04x"), debug_fetch16()); break;
	case 0xe5: _stprintf_s(buffer, buffer_len, _T("PUSH HL")); break;
	case 0xe6: _stprintf_s(buffer, buffer_len, _T("AND %02x"), debug_fetch8()); break;
	...
	case 0xea: _stprintf_s(buffer, buffer_len, _T("JP PE, %04x"), debug_fetch16()); break;
	case 0xeb: _stprintf_s(buffer, buffer_len, _T("EX DE, HL")); break;
	case 0xec: _stprintf_s(buffer, buffer_len, _T("CALL PE, %04x"), debug_fetch16()); break;
	case 0xed: dasm_ed(pc, buffer, buffer_len); break;
	case 0xee: _stprintf_s(buffer, buffer_len, _T("XOR %02x"), debug_fetch8()); break;
	...
	case 0xf2: _stprintf_s(buffer, buffer_len, _T("JP P, %04x"), debug_fetch16()); break;
	case 0xf3: _stprintf_s(buffer, buffer_len, _T("DI")); break;
	case 0xf4: _stprintf_s(buffer, buffer_len, _T("CALL P, %04x"), debug_fetch16()); break;
	case 0xf5: _stprintf_s(buffer, buffer_len, _T("PUSH AF")); break;
	case 0xf6: _stprintf_s(buffer, buffer_len, _T("OR %02x"), debug_fetch8()); break;
	...
	case 0xfa: _stprintf_s(buffer, buffer_len, _T("JP M, %04x"), debug_fetch16()); break;
	case 0xfb: _stprintf_s(buffer, buffer_len, _T("EI")); break;
	case 0xfc: _stprintf_s(buffer, buffer_len, _T("CALL M, %04x"), debug_fetch16()); break;
	case 0xfd: dasm_fd(pc, buffer, buffer_len); break;
	case 0xfe: _stprintf_s(buffer, buffer_len, _T("CP %02x"), debug_fetch8()); break;
...
void dasm_dd(uint32 pc, _TCHAR *buffer, size_t buffer_len)
{
	...
	case 0x21: _stprintf_s(buffer, buffer_len, _T("LD IX, %04x"), debug_fetch16()); break;
	case 0x22: _stprintf_s(buffer, buffer_len, _T("LD (%04x), IX"), debug_fetch16()); break;
	...
	case 0x26: _stprintf_s(buffer, buffer_len, _T("LD HX, %02x"), debug_fetch8()); break;
	case 0x29: _stprintf_s(buffer, buffer_len, _T("ADD IX, IX")); break;
	case 0x2a: _stprintf_s(buffer, buffer_len, _T("LD IX, (%04x)"), debug_fetch16()); break;
	...
	case 0x2e: _stprintf_s(buffer, buffer_len, _T("LD LX, %02x"), debug_fetch8()); break;
	...
	case 0x36: ofs = debug_fetch8_rel(); _stprintf_s(buffer, buffer_len, _T("LD (IX+(%d)), %02x"), ofs, debug_fetch8()); break;
	...
	default:   _stprintf_s(buffer, buffer_len, _T("DB dd")); z80_dasm_ptr--; break;
	}
}
...
void dasm_ed(uint32 pc, _TCHAR *buffer, size_t buffer_len)
{
	...
	case 0x43: _stprintf_s(buffer, buffer_len, _T("LD (%04x), BC"), debug_fetch16()); break;
	...
	case 0x4b: _stprintf_s(buffer, buffer_len, _T("LD BC, (%04x)"), debug_fetch16()); break;
	...
	case 0x53: _stprintf_s(buffer, buffer_len, _T("LD (%04x), DE"), debug_fetch16()); break;
	...
	case 0x5b: _stprintf_s(buffer, buffer_len, _T("LD DE, (%04x)"), debug_fetch16()); break;
	...
	case 0x63: _stprintf_s(buffer, buffer_len, _T("LD (%04x), HL"), debug_fetch16()); break;
	...
	case 0x6b: _stprintf_s(buffer, buffer_len, _T("LD HL, (%04x)"), debug_fetch16()); break;
	...
	case 0x73: _stprintf_s(buffer, buffer_len, _T("LD (%04x), SP"), debug_fetch16()); break;
	...
	case 0x7b: _stprintf_s(buffer, buffer_len, _T("LD SP, (%04x)"), debug_fetch16()); break;
	...
	default:   _stprintf_s(buffer, buffer_len, _T("DB ed")); z80_dasm_ptr--; break;
	}
}
...
void dasm_fd(uint32 pc, _TCHAR *buffer, size_t buffer_len)
{
	...
	case 0x21: _stprintf_s(buffer, buffer_len, _T("LD IY, %04x"), debug_fetch16()); break;
	case 0x22: _stprintf_s(buffer, buffer_len, _T("LD (%04x), IY"), debug_fetch16()); break;
	...
	case 0x26: _stprintf_s(buffer, buffer_len, _T("LD HY, %02x"), debug_fetch8()); break;
	case 0x29: _stprintf_s(buffer, buffer_len, _T("ADD IY, IY")); break;
	case 0x2a: _stprintf_s(buffer, buffer_len, _T("LD IY, (%04x)"), debug_fetch16()); break;
	...
	case 0x2e: _stprintf_s(buffer, buffer_len, _T("LD LY, %02x"), debug_fetch8()); break;
	...
	case 0x36: ofs = debug_fetch8_rel(); _stprintf_s(buffer, buffer_len, _T("LD (IY+(%d)), %02x"), ofs, debug_fetch8()); break;
	...
	default:   _stprintf_s(buffer, buffer_len, _T("DB fd")); z80_dasm_ptr--; break;
	}
}
