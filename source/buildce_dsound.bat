...
evc fmr30ce.vcp /MAKE "fmr30ce - Win32 (WCE ARMV4I) GDI_DSOUND" /REBUILD /CECONFIG="STANDARDSDK"
mkdir build\fmr30
copy GDI_DSOUND\fmr30ce.exe build\fmr30\.
...
evc fmr60ce.vcp /MAKE "fmr60ce - Win32 (WCE ARMV4I) GDI_DSOUND" /REBUILD /CECONFIG="STANDARDSDK"
mkdir build\fmr60
copy GDI_DSOUND\fmr60ce.exe build\fmr60\.

evc fmrcardce.vcp /MAKE "fmrcardce - Win32 (WCE ARMV4I) GDI_DSOUND" /REBUILD /CECONFIG="STANDARDSDK"
mkdir build\fmrcard
copy GDI_DSOUND\fmrcardce.exe build\fmrcard\.
...
evc mycomz80ace.vcp /MAKE "mycomz80ace - Win32 (WCE ARMV4I) GDI_DSOUND" /REBUILD /CECONFIG="STANDARDSDK"
mkdir build\mycomz80a
copy GDI_DSOUND\mycomz80ace.exe build\mycomz80a\.
...
evc pc8201ace.vcp /MAKE "pc8201ace - Win32 (WCE ARMV4I) GDI_DSOUND" /REBUILD /CECONFIG="STANDARDSDK"
mkdir build\pc8201a
copy GDI_DSOUND\pc8201ace.exe build\pc8201a\.
...
evc x1twince.vcp /MAKE "x1twince - Win32 (WCE ARMV4I) GDI_DSOUND" /REBUILD /CECONFIG="STANDARDSDK"
mkdir build\x1twin
copy GDI_DSOUND\x1twince.exe build\x1twin\.
