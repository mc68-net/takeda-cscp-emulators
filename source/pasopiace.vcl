...
<h1>ビルドのログ</h1>
<h3>
--------------------構成 : pasopiace - Win32 (WCE ARMV4I) GDI_DSOUND--------------------
</h3>
<h3>コマンド ライン</h3>
...
一時ファイル "C:\DOCUME~1\ADMINI~1\LOCALS~1\Temp\RSP181.tmp" を作成し、次の内容を記録します
[
...
一時ファイル "C:\DOCUME~1\ADMINI~1\LOCALS~1\Temp\RSP182.tmp" を作成し、次の内容を記録します
[
...
一時ファイル "C:\DOCUME~1\ADMINI~1\LOCALS~1\Temp\RSP183.tmp" を作成し、次の内容を記録します
[
...
コマンド ライン "link.exe @C:\DOCUME~1\ADMINI~1\LOCALS~1\Temp\RSP183.tmp" の作成中
<h3>アウトプット ウィンドウ</h3>
リソースをコンパイル中...
コンパイル中...
emu.cpp
